...
const Header = () => {
  ...
  const navigate = useRouter(); // useNavigate hook'unu çağırın
  ...
  const handleSearchSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Arama yapma işlemini buraya ekleyebilirsiniz. Örneğin, arama terimini bir API'ye gönderebilirsiniz.
  ...
  return (
    ...
    >
      <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
        {/* <!-- header top start --> */}
        <div
          className={`flex flex-col lg:flex-row gap-5 items-end lg:items-center xl:justify-between ease-out duration-200 py-4`}
        >
          {/* <!-- header top left --> */}
          <div className="xl:w-auto flex-col sm:flex-row w-full flex sm:justify-between sm:items-center gap-5 sm:gap-10">
            <Link className="flex-shrink-0" href="/">
              <Image
                src="https://www.reshot.com/preview-assets/icons/X53DM7FW8R/flower-X53DM7FW8R.svg"
                alt="Logo"
                width={85}
                height={85}
              />
            ...
            <div className="relative">
              <form onSubmit={handleSearchSubmit} className="flex items-center">
                <input
                  ...
                  className="px-4 py-2 rounded-full border border-gray-300 focus:outline-none bg-white focus:ring-2 focus:ring-blue-500"
                />
                <button
                  type="submit"
              ...
              >
                <span className="block relative cursor-pointer w-5.5 h-5.5">
                  <span className="du-block absolute right-0 w-full h-full">
                    <span
                      className={`block relative top-0 left-0rounded-sm w-0 h-0.5 my-1 ease-in-out duration-200 delay-[0] ${
                        !navigationOpen && "!w-full delay-300"
                      }`}
                    ></span>
                    <span
                      className={`block relative top-0 left-0rounded-sm w-0 h-0.5 my-1 ease-in-out duration-200 delay-150 ${
